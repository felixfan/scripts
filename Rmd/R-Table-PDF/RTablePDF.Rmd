...
stargazer(both2, type = "latex", summary = FALSE, rownames = FALSE)
```
...
```{r comment='', message=FALSE, warning=FALSE, results='asis'}
stargazer(both, type = "latex", nobs = FALSE, mean.sd = TRUE, median = TRUE, iqr = TRUE)
```

# Change which statistics are displayed (a second way)

```{r comment='', message=FALSE, warning=FALSE, results='asis'}
stargazer(both, type = "latex", summary.stat = c("n", "p75", "sd"))
```

# Remove logical variables in the summary statistics

```{r comment='', message=FALSE, warning=FALSE, results='asis'}
stargazer(both, type = "latex", summary.logical = FALSE)
```

# Flip the table axes

```{r comment='', message=FALSE, warning=FALSE, results='asis'}
stargazer(both, type = "latex", flip = TRUE)
```

# Control the number of decimal places

```{r comment='', message=FALSE, warning=FALSE, results='asis'}
stargazer(both, type = "latex", flip=TRUE, digits = 1)
```

# Drop leading zeros from decimals

```{r comment='', message=FALSE, warning=FALSE, results='asis'}
stargazer(both, type = "latex", flip=TRUE, digits = 1, initial.zero = FALSE)
```
