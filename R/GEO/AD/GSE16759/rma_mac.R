...
setwd("/Users/nolan/Downloads/GEO/GSE16759")
untar("GSE16759_RAW.tar", exdir="data")
cels = list.files("data/", pattern = "cel",ignore.case=TRUE) 

setwd("/Users/nolan/Downloads/GEO/GSE16759/data")
...
write.table(out, file = "GSE16759.rma.affy.txt", quote = FALSE, sep = "\t",row.names=FALSE)
