...
setwd("/Users/nolan/Downloads/GEO/GSE12685")
untar("GSE12685_RAW.tar", exdir="data")
cels = list.files("data/", pattern = "cel") 

setwd("/Users/nolan/Downloads/GEO/GSE12685/data")
...
write.table(out, file = "GSE12685.rma.affy.txt", quote = FALSE, sep = "\t",row.names=FALSE)
