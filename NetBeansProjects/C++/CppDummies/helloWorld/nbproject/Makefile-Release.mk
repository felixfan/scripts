...
${OBJECTDIR}/AddOne.o: AddOne.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AddOne.o AddOne.cpp

${OBJECTDIR}/BigDog.o: BigDog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BigDog.o BigDog.cpp

${OBJECTDIR}/ChangesAreGood.o: ChangesAreGood.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChangesAreGood.o ChangesAreGood.cpp

${OBJECTDIR}/CharString.o: CharString.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharString.o CharString.cpp

${OBJECTDIR}/GetSecretCode.o: GetSecretCode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GetSecretCode.o GetSecretCode.cpp

${OBJECTDIR}/GlobalVar.o: GlobalVar.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GlobalVar.o GlobalVar.cpp
...
${OBJECTDIR}/MathExamples.o: MathExamples.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MathExamples.o MathExamples.cpp

${OBJECTDIR}/MessMeUp.o: MessMeUp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessMeUp.o MessMeUp.cpp

${OBJECTDIR}/Paranoid.o: Paranoid.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Paranoid.o Paranoid.cpp

${OBJECTDIR}/PointerVariable.o: PointerVariable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointerVariable.o PointerVariable.cpp

${OBJECTDIR}/PrintName.o: PrintName.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrintName.o PrintName.cpp
