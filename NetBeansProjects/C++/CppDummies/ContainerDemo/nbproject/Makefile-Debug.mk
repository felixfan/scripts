...
${OBJECTDIR}/copyingContainer.o: copyingContainer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/copyingContainer.o copyingContainer.cpp

${OBJECTDIR}/dequeDemo.o: dequeDemo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dequeDemo.o dequeDemo.cpp

${OBJECTDIR}/iteratorDemo.o: iteratorDemo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iteratorDemo.o iteratorDemo.cpp

${OBJECTDIR}/listDemo.o: listDemo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listDemo.o listDemo.cpp
...
${OBJECTDIR}/mapDemo.o: mapDemo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mapDemo.o mapDemo.cpp

${OBJECTDIR}/setDemo.o: setDemo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/setDemo.o setDemo.cpp

${OBJECTDIR}/stackQueue.o: stackQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stackQueue.o stackQueue.cpp

${OBJECTDIR}/vectorDemo.o: vectorDemo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vectorDemo.o vectorDemo.cpp
